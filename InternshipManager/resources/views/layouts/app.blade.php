    ...
    <body>        
        <div class="bg-indigo-700 p-4 flex justify-between items-center">
            <div class="flex items-center">
                ...
                <a href="#" class="inline-block p-2 text-indigo-200 hover:text-indigo-100">Admin</a>
            </div>
            <div class="hidden md:block">
                <a href="{{ route('register')}}" class="inline-block p-2 text-green-800 bg-green-400 hover:bg-green-300 hover:text-green-800 rounded transition">Sign Up for Students</a>
            </div>
        </div>
        ...
        <div class="md:flex justify-between py-20 px-10 bg-indigo-600 text-indigo-100">
            <div class="md:w-1/2 mb-10 md:mb-0">
              ...
              <a href="{{ route('login') }}" class="inline-block py-3 px-6 text-lg bg-green-400 text-green-800 hover:bg-green-300 rounded mr-2">Login for Students</a>
              <a href="#" class="inline-block py-3 px-6 text-lg bg-blue-400 text-blue-800 hover:bg-blue-300 rounded mr-2">Login for Teachers</a>
              <a href="#" class="inline-block py-3 px-6 text-lg bg-purple-400 text-purple-800 hover:bg-purple-300 rounded">Login for Coordiators</a>
            </div>
            <div class="md:w-1/2">
